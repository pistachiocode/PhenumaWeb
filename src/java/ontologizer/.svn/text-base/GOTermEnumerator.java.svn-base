...
//	private int suspiciousCount;
	 ...
	 */
	public void push(PP2Associations geneAssociations)
	{
	 ...
	 */
	public void push(PP2Associations geneAssociations, Set<ByteString> evidences)
	{
		ByteString geneName = geneAssociations.id();
