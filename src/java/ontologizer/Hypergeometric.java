...
public class Hypergeometric
{
	...
	public Hypergeometric()
	{
        ...
        public static void main(String[] args)
        {
            ...
            System.out.println(h.logfact(10));
            System.out.println(h.lNchooseK(100, 10));
            ...
            System.out.println(Math.exp(h.lNchooseK(M,x)+h.lNchooseK(N,n-x)-h.lNchooseK(N,n)));
            System.out.println(h.dhyper(x, N, M , n));
        }
