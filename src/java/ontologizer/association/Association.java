...
public class Association
{
	...
	private final static int DBNAME = 0;
...
//		new String[] {"", "NOT", "contributes_to", "colocalizes_with"};
	...
	/** Index of HPO:id field */
	private final static int HPOFIELD = 4;

	/** ADDED Index of DB:Reference field */
	private final static int DBREFERENCE = 5;
	...
	{
		DB_Object = synonym = new ByteString("");
                /*Era db_object_symbol pero lo cambie a DB_Object para hacer pruebas manuales con ontologias. La aplicacion
                 suele usar parseLine en vez de este constructor.*/
		DB_Object = db_object_symbol;
	...
	private void parseLine(String line) throws Exception
	{
		...
		String[] fields = pattern.split(line, FIELDS);
                ...
                this.DB_Name = new ByteString(fields[DBNAME].trim());
		 ...
		 * ADDED DB:Reference
		 */
		this.dbReference = new ByteString(fields[DBREFERENCE]);
		...
		this.termID = new TermID(fields[HPOFIELD]);
...
/*		if (fields[ASPECTFIELD].equals("P") 
        ...
        /**
	 * Returns the DB_Name (OMIM, UniProt, ect) of the object of this association.
	 * 
	 * @return the term id.
	 */
	...
	/**
	 * ADDED: Returns the database reference
	 * 
	 * @return
	 */
