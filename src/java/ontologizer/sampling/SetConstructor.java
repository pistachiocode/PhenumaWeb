...
public class SetConstructor
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			AssociationContainer assocs = new AssociationContainer(assocParser.getAssociations(), assocParser.getSynonym2gene(), assocParser.getDbObject2gene(), true, null);
			...
			Set<ByteString> allAnnotatedGenes = assocs.getAllAnnotatedPP();
			PopulationSet completePop = new PopulationSet("AllAnnotated");
			for (ByteString gene : allAnnotatedGenes)
				completePop.addElement(gene, "None");
			popSize = java.lang.Math.min(completePop.getSize(), popSize);
			...
			} else if (completeSet || popSize == completePop.getSize())
			{
