...
public class StudySetSampler
{
			...
			Iterable<ByteString> repository)
	{
		...
		HashSet<ByteString> weHave = studySet.getAllNodesNames();
		...
		{
			studySet.addElement(gene, baseStudySet.getGeneDescription(gene));
		}
	}
			...
			TermID[] termsToOverRepresent, double OverRepresentationRatio)
	{
		...
		HashSet<ByteString> genesRest = studySet.getAllNodesNames();
