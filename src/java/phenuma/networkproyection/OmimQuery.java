...
public class OmimQuery extends NetworkQuery implements QueryOperations
{
    ...
    {
      try {
            logger.info("executeQuery: "+queryType+" input "+studySet.toString());
           ...
           //Genes networks: get genes related with input omim.
            ...
            if (!NetworkUtils.isBipartite(queryType)){
                networknodesset = q.getNetworkNodes(relatedObjectsStudySet, NetworkConstants.INPUT_TYPE_OMIM, queryType, this.threshold);
