...
function qtipcontent_gene(gene)
{
    ...
    {  
        ...
        {
            tip = tip  + phenotypes.orphandiseases[i].name.toLowerCase() + " ("+ insertLinkHTML(phenotypes.orphandiseases[i], ' ORPHA'+phenotypes.orphandiseases[i].id, orphanum_type) + ") ,"
        }
...
//    
//    return nodeX.label+" "+nodeY.label;
    /*
   // var str = getQtipInformaionJSON();
...
function destroyQtipWindow()
{
    $("#infolayoutunit").qtip('destroy', true); 
}



function modalWindow(content, title)
{
